...
Source0  : https://files.pythonhosted.org/packages/9f/67/9442fd49ac0d234933c9c90cb2e2f072d9df021577547c09456dd4484ed4/tldextract-3.4.0.tar.gz
...
%prep
%setup -q -n tldextract-3.4.0
cd %{_builddir}/tldextract-3.4.0
pushd ..
cp -a tldextract-3.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1664983306
