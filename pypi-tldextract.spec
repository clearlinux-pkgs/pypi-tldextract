...
%prep
%setup -q -n tldextract-3.3.0
cd %{_builddir}/tldextract-3.3.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1651759941
...
cp %{_builddir}/tldextract-3.3.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tldextract/b8641358e21254308b9a6258fc93eed20c9f7960
