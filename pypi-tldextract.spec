...
Source0  : https://files.pythonhosted.org/packages/02/21/4f2d7d6023650770112dd8144dbc47afabbfaf568a0d39abc0a4f37e8e9e/tldextract-5.1.1.tar.gz
...
%prep
%setup -q -n tldextract-5.1.1
cd %{_builddir}/tldextract-5.1.1
pushd ..
cp -a tldextract-5.1.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1700239852
