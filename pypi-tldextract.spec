...
Source0  : https://files.pythonhosted.org/packages/29/93/6291afba24410e9925ac825e415c7b875b6246fc541fd619cbadc3a97aca/tldextract-5.1.0.tar.gz
...
%prep
%setup -q -n tldextract-5.1.0
cd %{_builddir}/tldextract-5.1.0
pushd ..
cp -a tldextract-5.1.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1699286426
