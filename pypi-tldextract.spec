...
Source0  : https://files.pythonhosted.org/packages/4a/4f/eee4bebcbad25a798bf55601d3a4aee52003bebcf9e55fce08b91ca541a9/tldextract-5.1.3.tar.gz
...
%prep
%setup -q -n tldextract-5.1.3
cd %{_builddir}/tldextract-5.1.3
pushd ..
cp -a tldextract-5.1.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1730823699
...
cp %{_builddir}/tldextract-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-tldextract/99e17de1682cdaf3b97f45c7d380c969c24360a4 || :
...
/usr/share/package-licenses/pypi-tldextract/99e17de1682cdaf3b97f45c7d380c969c24360a4
