...
Source0  : https://files.pythonhosted.org/packages/ef/c9/664bbac3f41af3621f324d75844c12b331c1079d9458cf0ecfd54866c704/tldextract-3.0.0.tar.gz
...
%prep
%setup -q -n tldextract-3.0.0
cd %{_builddir}/tldextract-3.0.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1603223131
...
cp %{_builddir}/tldextract-3.0.0/LICENSE %{buildroot}/usr/share/package-licenses/tldextract/b8641358e21254308b9a6258fc93eed20c9f7960
